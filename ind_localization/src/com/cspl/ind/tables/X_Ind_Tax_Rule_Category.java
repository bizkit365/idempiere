...
/** Generated Model for Ind_Tax_Rules
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_Ind_Tax_Rule_Category extends PO implements I_Ind_Tax_Rule_Category, I_Persistent 
{
    ...
    public X_Ind_Tax_Rule_Category (Properties ctx, int Ind_Tax_Rule_Category_ID, String trxName)
    {
      super (ctx, Ind_Tax_Rule_Category_ID, trxName);
      /** if (Ind_Tax_Rules_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_Ind_Tax_Rule_Category (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Ind_Tax_Rule_Category[")
	...
	/** Set Ind_Tax_Rules_ID.
		@param Ind_Tax_Rule_Category_ID 
		Tax Rules ID
	  */
	public void setInd_Tax_Rule_Category_ID (double Ind_Tax_Rule_Category_ID)
	{
		if (Ind_Tax_Rule_Category_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Ind_Tax_Rule_Category_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Ind_Tax_Rule_Category_ID, Double.valueOf(Ind_Tax_Rule_Category_ID));
	}
	...
	{
		Integer ii = (int)get_Value(COLUMNNAME_Ind_Tax_Rule_Category_ID);
		if (ii == null)	 return 0;
		return ii.intValue();
	}

	/** Set Ind_Tax_Rules_UU.
		@param Ind_Tax_Rule_Category_UU 
		Ind_Tax_Rules_UU
	  */
	public void setInd_Tax_Rule_Category_UU (String Ind_Tax_Rule_Category_UU)
	{
		set_Value (COLUMNNAME_Ind_Tax_Rule_Category_UU, Ind_Tax_Rule_Category_UU);
	}

	/** Get Ind_Tax_Rules_UU.
		@return Ind_Tax_Rules_UU
	  */
	public String getInd_Tax_Rule_Category_UU () 
	{
		return (String)get_Value(COLUMNNAME_Ind_Tax_Rule_Category_UU);
	}
	...
	{
		set_Value (COLUMNNAME_tax_rate, Double.valueOf(tax_rate));
	}
	...
	{
		Double ii = (double)get_Value(COLUMNNAME_tax_rate);
		if (ii == null) 			 return 0;
		return ii.intValue();
	}
