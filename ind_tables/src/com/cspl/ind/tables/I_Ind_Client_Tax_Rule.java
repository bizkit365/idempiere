...
/** Generated Interface for Ind_Client_Tax_Rules
 *  @author iDempiere (generated) 
 *  @version Release 5.1
 */
@SuppressWarnings("all")
public interface I_Ind_Client_Tax_Rule 
{

    /** TableName=Ind_Client_Tax_Rules */
    public static final String Table_Name = "Ind_Client_Tax_Rules";
    ...
    /** Column name Ind_Client_Tax_Rules_UU */
    public static final String COLUMNNAME_Ind_Client_Tax_Rules_UU = "Ind_Client_Tax_Rules_UU";
    ...
    public static final String COLUMNNAME_Ind_Tax_Rules_ID = "Ind_Tax_Rules_ID";
