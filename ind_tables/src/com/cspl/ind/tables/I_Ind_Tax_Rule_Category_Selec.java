...
/** Generated Interface for Ind_Tax_Rules_Detail
 *  @author iDempiere (generated) 
 *  @version Release 5.1
 */
@SuppressWarnings("all")
public interface I_Ind_Tax_Rule_Category_Selec 
{

    /** TableName=Ind_Tax_Rules_Detail */
    public static final String Table_Name = "I_Ind_Tax_Rule_Category_Selec";
    ...
    /** Column name Ind_Tax_Rules_Detail_ID */
    public static final String COLUMNNAME_Ind_Tax_Rule_Category_Selec_ID = "Ind_Tax_Rule_Category_Selec_ID";
    ...
    /** Column name Ind_Tax_Rules_Detail_UU */
    public static final String COLUMNNAME_Ind_Tax_Rule_Category_Selec_UU = "Ind_Tax_Rule_Category_Selec_UU";

	/** Set Ind_Tax_Rules_Detail_UU	  */
	public void setInd_Tax_Rule_Category_Selec_UU (String Ind_Tax_Rule_Category_Selec_UU);
	...
	/** Set Ind_Tax_Rules_ID.
	  * Tax Rules ID
	  */
	public void setInd_Tax_Rules_Category_ID (int Ind_Tax_Rules_Category_ID);
