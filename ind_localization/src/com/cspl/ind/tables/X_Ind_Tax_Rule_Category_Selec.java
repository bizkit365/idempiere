...
/** Generated Model for Ind_Tax_Rules_Detail
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_Ind_Tax_Rule_Category_Selec extends PO implements I_Ind_Tax_Rule_Category_Selec, I_Persistent 
{
    ...
    public X_Ind_Tax_Rule_Category_Selec (Properties ctx, int Ind_Tax_Rule_Category_Selec_ID, String trxName)
    {
      super (ctx, Ind_Tax_Rule_Category_Selec_ID, trxName);
      /** if (Ind_Tax_Rules_Detail_ID == 0)
        {
			setInd_Buyer_Tax_Entity_Type_ID (0);
			setInd_Seller_Tax_Entity_Type_ID (0);
			setInd_Tax_Category_ID (0);
			setInd_Tax_Rules_Detail_ID (0);
    ...
    /** Load Constructor */
    public X_Ind_Tax_Rule_Category_Selec (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Ind_Tax_Rule_Category_Selec[")
	...
	{
		Double bd = (double)get_Value(COLUMNNAME_Ind_Cess_Rate);
		if (bd == null) return 0;
		return bd;
	}
	...
	/** Set Indian Tax Rules - Detail Table.
		@param Ind_Tax_Rule_Category_Selec_ID Indian Tax Rules - Detail Table	  */
	public void setInd_Tax_Rule_Category_Selec_ID (int Ind_Tax_Rule_Category_Selec_ID)
	{
		if (Ind_Tax_Rule_Category_Selec_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Ind_Tax_Rule_Category_Selec_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Ind_Tax_Rule_Category_Selec_ID, Integer.valueOf(Ind_Tax_Rule_Category_Selec_ID));
	}

	/** Get Indian Tax Rules - Detail Table.
		@return Indian Tax Rules - Detail Table	  */
	public int getInd_Tax_Rule_Category_Selec_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Ind_Tax_Rule_Category_Selec_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set Ind_Tax_Rules_Detail_UU.
		@param Ind_Tax_Rules_Detail_UU Ind_Tax_Rules_Detail_UU	  */
	public void setInd_Tax_Rule_Category_Selec_UU (String Ind_Tax_Rules_Detail_UU)
	{
		set_Value (COLUMNNAME_Ind_Tax_Rule_Category_Selec_UU, Ind_Tax_Rules_Detail_UU);
	}

	/** Get Ind_Tax_Rules_Detail_UU.
		@return Ind_Tax_Rules_Detail_UU	  */
	public String getInd_Tax_Rule_Category_Selec_UU () 
	{
		return (String)get_Value(COLUMNNAME_Ind_Tax_Rule_Category_Selec_UU);
	}
	...
	/** Set Ind_Tax_Rules_ID.
		...
		Tax Rules ID
	  */
	public void setInd_Tax_Rules_Category_ID (int Ind_Tax_Rules_ID)
	{
		if (Ind_Tax_Rules_ID < 1) 
			set_Value (COLUMNNAME_Ind_Tax_Rule_Category_ID, null);
		else 
			set_Value (COLUMNNAME_Ind_Tax_Rule_Category_ID, Integer.valueOf(Ind_Tax_Rules_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Ind_Tax_Rule_Category_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		Double bd = (double)get_Value(COLUMNNAME_tax_rate);
		if (bd == null) return 0;
		return bd;
	}
